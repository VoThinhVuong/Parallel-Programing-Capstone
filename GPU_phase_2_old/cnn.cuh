...
// Complete CNN model (GPU version) - OPTIMIZED MEMORY
typedef struct {
    // Layers
    ConvLayer* conv1;
    MaxPoolLayer* pool1;
    ...
    // OPTIMIZED: ReLU done in-place, no separate buffers needed
    // conv1->d_output serves as conv1_relu output
    // conv2->d_output serves as conv2_relu output
    // fc1->d_output serves as fc1_relu output
    
    // Shared gradient buffer for temporary computations
    float* d_shared_grad_buffer;  // Reused across layers
